<?php
	...
	include('connect_db.php');
        ...
        && isset($_POST['numQues']) && $_POST['numQues'] != ""){
            ...
            $fetch=mysqli_query("SELECT id FROM quizes 
            ...
            if($count!="")
            {
                ...
                mysqli_query("INSERT INTO quizes (quiz_name, display_questions, time_allotted) 
                	VALUES ('$qName','$nQues','$qTime')")or die(mysql_error());
                
                $lastId = mysql_insert_id();
                mysqli_query("UPDATE quizes SET quiz_id='$lastId' 
